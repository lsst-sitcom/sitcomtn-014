...
If continued into operations, it is recommended the vault is reorganize so that legacy data is archived for access but is not easily mistaken for as-built design data.
...
Databases and servers managed by SLAC used these tools to capture procedure, testing data, track component/assembly status and information, and track the acceptance and non-conformance reports.
Both the "prod" and "dev" instances including information on production parts.
...
In operations, the project will use openMAINT\textregistered\ as a customize Computerized Maintenance Management System (CMMS), with the assistance from the managing company, Tecnoteca srl\copyright . \citep{openmaint-cite}
...
It is recommended the project should confirm that the normative source for information for risk, opportunities and mitigations will be Jira.
