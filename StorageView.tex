...
% It needs to be stated here that the CMNMS is a means for which the constructionm p[rojects saticefies one of its deliverables at completion.
% openMaint was selected by the construction project to meet one of its comnpleteness critieria as outlined in SITCOMTN-0056.
...
% In order for the construction projecxt to meet its obligations the afore mentioned review and initial content definition must happen well before the start of operations.
...
% This sections seems a bit vague regarding what "other information" is defined to be.
...
% I think here in this section and elsewhere in the documentation it needs to be moire clearly stated what we are proposing the construction projecty is obligated to deliver and what is being left at the discrewtion of the Operations phase.
