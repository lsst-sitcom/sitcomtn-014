...
The new Rubin Documentation Portal discussed herein is based upon the website \href{www.lsst.io} which provides a search and browsing interface for the Rubin Observatory's public-facing technical documentation operated by the SQuaRE (Data Management) team. \citep{lsst.io-cite}
(While summarized in this document, a detailed description of \href{www.lsst.io}, LSST the Docs (LTD) and applicable software is available in \citedsp{SITCOMTN-012}.)
