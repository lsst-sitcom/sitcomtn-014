...
For example, all identified normative sources of information should be completed; or, a use case where multiple documents references one normative source better supports a stakeholder needs instead of all the information into a single document.
