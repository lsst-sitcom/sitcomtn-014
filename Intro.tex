...
This document serves as a roadmap developed by the Vera C.\ Rubin Observatory Project-wide Documentation Working Group in partial fullfilment of its charge,  defined in \citeds{LSE-489}.
...
The strategies in this proposal aim to support Rubin Observatory Cpnstruction staff to reliably and confidently demonstrate operations readiness, \citeds{SITCOMTN-005},  and execute operational expectations throughout operations --- lasting impact on science, strong work safety and environmentally sustainable culture with continuous improvement, and integrated and diverse community interaction.  
...
\emph{An evaluation of the level of effort and resources needed to realize this proposal is presented in a separate document, \citeds{RTN-076}. 
